...
import com.weather.sweet.xww.applibaray.net.rest.download.DownloadTask;
...
public class RestClient {
    ...
    RestClient(String url, WeakHashMap<String, Object> params, IRequest request, ISuccess success, IFailure failure,
    ...
    private Callback<String> getRestCallback() {
        return new RestCallback(REQUEST, SUCCESS, FAILURE, ERROR);
    }
